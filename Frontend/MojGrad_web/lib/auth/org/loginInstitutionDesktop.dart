...
class LoginInstitutionDesktop extends StatefulWidget {
  @override
  _LoginInstitutionDesktopState createState() =>
      _LoginInstitutionDesktopState();
}

class _LoginInstitutionDesktopState extends State<LoginInstitutionDesktop> {
  String _email = "";
  String _password = "";
  String error = "";
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Center(
          child: Card(
            elevation: 5,
            margin: EdgeInsets.symmetric(horizontal: 150, vertical: 25),
            shape:
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          buildCustomTextField("", "Lozinka", Icons.lock, true),
                          SizedBox(height: 30.0),
                          Row(
                                          ...
                                          await APIServicesUsers.checkUser(
                                            ...
                                            (jwt) async {
                                              if (jwt != null) {
                                                ...
                                                var payload = json.decode(
                                                    ascii.decode(base64.decode(
                                                        base64.normalize(jwt
                                                            .split(".")[1]))));

                                                if (payload['sub'] == "admin") {
                                                  loggedAdminID = int.parse(
                                                      payload['nameid']);
                                                  loggedAdminHead = int.parse(
                                                      payload['Head']);
                                                } else {
