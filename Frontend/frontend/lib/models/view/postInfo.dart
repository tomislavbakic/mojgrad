...
class PostInfo {
  ...
  void set setActivity(bool active) {
    if (active == true)
      _active = 1;
    else
      _active = 0;
  ...
  set likesNumber(int numb) => this._likesNumber = numb;
  set commentsNumber(int commentNum) => this._commentsNumber = commentNum;
